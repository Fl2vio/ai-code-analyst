...
export default function Hero() {
  ...
  return (
    <section id="hero" style={{ position: 'relative', height: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
      ...
      />
      <div style={{ position: 'absolute', inset: 0, background: 'radial-gradient(ellipse at center, rgba(5,8,16,0.3) 0%, rgba(5,8,16,0.75) 100%)', zIndex: 1 }} />
      ...
      <div style={{ position: 'relative', zIndex: 2, textAlign: 'center', padding: '0 24px', maxWidth: '900px', width: '100%' }}>
              ...
              {line.split(' ').map((word, wi) => (
                <motion.span
                  ...
                  style={{
                    ...
                    background: li === 1 ? 'linear-gradient(135deg, #00e5ff 0%, #7c3aed 100%)' : 'none',
        ...
        >
          A multi-agent AI pipeline that detects bugs, measures real performance, generates optimized code, and validates every improvement with Docker sandbox execution.
        </motion.p>
        ...
        <motion.div
          ...
          style={{ display: 'flex', gap: '16px', justifyContent: 'center', marginTop: '40px', flexWrap: 'wrap' }}
        >
          <a
            href="#architecture"
            style={{
            ...
            onMouseLeave={e => e.currentTarget.style.boxShadow = '0 0 24px rgba(0,229,255,0.35)'}
          >
            View Architecture
          </a>
          <a
            ...
            onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(255,255,255,0.2)'; e.currentTarget.style.color = '#e2e8f0' }}
          >
            GitHub →
          </a>
        </motion.div>
        ...
        <motion.div
          ...
          style={{ display: 'flex', gap: '8px', justifyContent: 'center', marginTop: '28px', flexWrap: 'wrap' }}
        >
          {['Python', 'FastAPI', 'React', 'Gemini 2.0', 'Docker', 'OpenRouter'].map(tech => (
            <span key={tech} style={{
              fontFamily: 'IBM Plex Mono, monospace',
              fontSize: '10.5px',
              color: '#4b5563',
      ...
      >
        <span style={{ fontFamily: 'IBM Plex Mono, monospace', fontSize: '0.62rem', letterSpacing: '0.15em', color: '#6b7a99', textTransform: 'uppercase' }}>Scroll</span>
        <motion.div
          animate={{ y: [0, 8, 0] }}
          transition={{ repeat: Infinity, duration: 1.6, ease: 'easeInOut' }}
          style={{ width: '1px', height: '40px', background: 'linear-gradient(to bottom, #00e5ff, transparent)' }}
        />
      </motion.div>
    </section>
  )
