...
const members = [
  {
    ...
    quote:
      "Designed the multi-agent pipeline and the Docker-backed validator that proves every optimization works.",
    accent: "#7c3aed",
  },
  {
    name: "Marcus Reid",
    ...
    quote:
      "Built the AI agents that detect bugs and generate optimized code using Gemini 2.0.",
    accent: "#f59e0b",
  },
  {
    name: "Kai Nakamura",
    ...
    quote:
      "Built the Docker sandbox that safely executes untrusted code and measures real performance.",
    accent: "#00e5ff",
  },
  {
    name: "Sofia Vance",
    ...
    quote:
      "Built the React web interface and FastAPI integration that connects all agents into one product.",
    accent: "#10b981",
  },
];
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        >
          ...
          >
            Built by Engineers,
            <br />
            <span style={{ color: "#00e5ff" }}>For Engineers.</span>
          </h2>
          <p
            style={{
          ...
          >
            A focused team of specialists — every component of the pipeline
            owned end-to-end.
          </p>
        </motion.div>
