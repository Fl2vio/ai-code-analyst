  ...
  [8571],
  {
      ...
      var r = n(25773),
        ...
        a = i.forwardRef(function (e, t) {
          return i.createElement(
            ...
            i.createElement("path", { fill: "none", d: "M0 0h24v24H0V0z" }),
    ...
    51622: (e, t, n) => {
      ...
      var k = "file-invalid-type",
        ...
        T = { code: P, message: "Too many files" };
      function I(e, t) {
      ...
      var ne = (0, r.forwardRef)(function (e, t) {
            ...
            var Q = (0, r.useCallback)(
                function (e) {
                  (e.preventDefault(),
                    e.persist(),
                    be(e),
                    (W.current = [].concat($(W.current), [e.target])),
                    K(e) &&
                      ...
                      .catch(function (e) {
                        ...
                        ("AbortError" === t.name || t.code === t.ABORT_ERR)
                          ...
                          : (function (e) {
                            ...
                            ((_.current = !1),
                            C.current &&
                              ((C.current.value = null), C.current.click()));
                      });
                  } else
                    C.current &&
                      (S({ type: "openDialog" }),
        ...
        return (
          ...
          r.createElement(r.Fragment, null, n(X(X({}, a), {}, { open: o })))
        );
      });
              ...
              return s(e) && s(e.dataTransfer)
                ...
                : (function (e) {
                  ...
                  : Array.isArray(e) &&
                      e.every(function (e) {
                        return (
                          "getFile" in e && "function" === typeof e.getFile
                        );
                      })
                    ? [2, p(e)]
                    : [2, []];
      ...
      ((ne.defaultProps = re),
        (ne.propTypes = {
          children: o().func,
          accept: o().oneOfType([o().string, o().arrayOf(o().string)]),
          multiple: o().bool,
      ...
      function ae(e, t) {
        switch (t.type) {
          case "focus":
            return X(X({}, e), {}, { isFocused: !0 });
          case "blur":
            return X(X({}, e), {}, { isFocused: !1 });
          case "openDialog":
            return X(X({}, oe), {}, { isFileDialogActive: !0 });
          case "closeDialog":
            return X(X({}, e), {}, { isFileDialogActive: !1 });
          case "setDraggedFiles":
            var n = t.isDragActive,
              r = t.draggedFiles;
            return X(X({}, e), {}, { draggedFiles: r, isDragActive: n });
          case "setFiles":
            return X(
              X({}, e),
              {},
