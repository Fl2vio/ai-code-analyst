  ...
  [9330],
  {
    69330: (e, t, r) => {
      ...
      var n = r(66845),
        u = r(40864);
      function s(e) {
        let { element: t, width: r, endpoints: s, elementMgr: a } = e;
        const i = (0, n.useRef)(null),
          { startTime: d, endTime: c, loop: l, autoplay: o } = t,
          m = (0, n.useMemo)(() => {
            if (!t.id) return !0;
            const e = a.getElementState(t.id, "preventAutoplay");
            return (
              e || a.setElementState(t.id, "preventAutoplay", !0),
              null !== e && void 0 !== e && e
            );
          }, [t.id, a]);
        ((0, n.useEffect)(() => {
          ...
          (0, n.useEffect)(() => {
            ...
            const r = () => {
              c > 0 &&
                e.currentTime >= c &&
                (l
                  ? ((e.currentTime = d || 0), e.play())
                  : t || ((t = !0), e.pause()));
            };
            return (
              c > 0 && e.addEventListener("timeupdate", r),
              () => {
