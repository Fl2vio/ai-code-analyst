  ...
  [8427],
  {
    18427: (e, t, o) => {
      ...
      var i = o(66845),
        ...
        c = o(22704),
        p = o(1515);
      const g = (0, p.Z)("button", { target: "elibz2u3" })((e) => {
          let { theme: t } = e;
          return {
        ...
        u = (0, p.Z)("div", { target: "elibz2u2" })((e) => {
          let { theme: t } = e;
          return {
            display: "flex",
            flexDirection: "row",
            gap: t.spacing.lg,
            "> span": { marginTop: t.spacing.twoXS },
          };
        }, ""),
        h = (0, p.Z)("div", { target: "elibz2u0" })((e) => {
          let { theme: t } = e;
          return {
            display: "flex",
      ...
      var f = o(40864);
      const b = (0, s.b)(function (e) {
        let { theme: t, body: o, icon: s, width: p } = e;
        const b = (function (e) {
            if (e.length > 104) {
              let t = e.replace(/^(.{104}[^\s]*).*/, "$1");
              return (
                t.length > 104 &&
                  (t = t.substring(0, 104).split(" ").slice(0, -1).join(" ")),
                t.trim()
              );
            }
            return e;
          ...
          T = (0, i.useMemo)(
            () =>
              (function (e) {
                ...
                return {
                  Body: {
                    props: { "data-testid": "stToast", className: "stToast" },
                    style: {
                      display: "flex",
                      flexDirection: "row",
                      gap: e.spacing.md,
        ...
        ((0, i.useEffect)(() => {
          if (t.inSidebar) return;
          const e = r.Z.info(z, { overrides: { ...T } });
          return (
            S(e),
            () => {
              (r.Z.update(e, {
          ...
          (0, i.useEffect)(() => {
            r.Z.update(y, { children: z, overrides: { ...T } });
          }, [y, z, T]));
        const R = (0, f.jsx)(d.Z, {
          kind: l.h.ERROR,
        ...
        return (0, f.jsx)(f.Fragment, { children: t.inSidebar && R });
      });
    },
  },
]);
