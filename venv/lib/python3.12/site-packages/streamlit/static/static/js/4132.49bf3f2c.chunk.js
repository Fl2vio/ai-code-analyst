            ...
            var c = (function (e) {
              ...
              return (
                ...
                (t.prototype.componentDidUpdate = function (e) {
                  ...
                  if (s()) {
                    var r =
                      ...
                      n = e.minScreenshotWidth !== t.minScreenshotWidth,
                      o = e.minScreenshotHeight !== t.minScreenshotHeight;
                    ((i || n || o) && ((this.canvas = null), (this.ctx = null)),
                      (r || i) &&
                ...
                (t.prototype.getScreenshot = function (e) {
                  ...
                  return (
                    i && i.toDataURL(r.screenshotFormat, r.screenshotQuality)
                  );
                }),
                (t.prototype.getCanvas = function (e) {
                  ...
                  if (!this.ctx) {
                    ...
                    if (!this.props.forceScreenshotSourceSize) {
                      var o = i / n;
                      ((n =
                        (i = r.minScreenshotWidth || this.video.clientWidth) /
                        o),
                        r.minScreenshotHeight &&
                          n < r.minScreenshotHeight &&
                          (i = (n = r.minScreenshotHeight) * o));
                    }
                    ((this.canvas = document.createElement("canvas")),
                      (this.canvas.width =
                        (null === e || void 0 === e ? void 0 : e.width) || i),
                      (this.canvas.height =
                        (null === e || void 0 === e ? void 0 : e.height) || n),
                ...
                (t.prototype.requestUserMedia = function () {
                  var e = this,
                    r = this.props,
                    i = function (i, n) {
                      var o = { video: "undefined" === typeof n || n };
                      (r.audio && (o.audio = "undefined" === typeof i || i),
                  ...
                  if ("mediaDevices" in navigator)
                    i(r.audioConstraints, r.videoConstraints);
                  else {
                    var n = function (e) {
                    ...
                    MediaStreamTrack.getSources(function (e) {
                      ...
                      var s = o(r.audioConstraints);
                      s && (t = s);
                      var c = o(r.videoConstraints);
                      (c && (a = c), i(n(t), n(a)));
                    });
                  }
                }),
                ...
                (t.prototype.render = function () {
                  var e = this,
                    ...
                    h = s
                      ? o(o({}, d), {
                          transform: (d.transform || "") + " scaleX(-1)",
                        })
                      : d,
